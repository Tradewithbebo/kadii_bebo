...
export function SellCrypto() {
  ...
  return (
   ...
   <Notification/>
      ...
      <GridItem  colSpan={[1,3]} display="flex" justifyContent="center" alignItems="center">
        <Box  >
          <Divider width={"200px"}  />
        </Box>
      </GridItem>
      {/* second part */}
        ...
        <GridItem colSpan={1} mt={["15px",'32px']}w={'full'} >
          <HStack>
          <Box>
            <Text fontWeight={"600"}  fontSize={['11px',"16px"]} color={"#808080"}>
              Crypto:
            </Text>
          </Box>
          ...
          <MenuButton w={['100%']}>
            ...
            <MenuList>
              {MenuItems.map((item) => (
                <MenuItem key={item.title} minH="10px" onClick={() => handleCryptoSelect(item.title)}>
                  {item.img}
        ...
        <GridItem colSpan={1}  mt={['14px','32px']}  display={{ base: 'none', md: 'block' }}>
          <Box display="flex" justifyContent="center" alignItems="center">
          <Divider orientation="vertical" h={"50px"} mr={"24px"} ml={"24px"} color={'#F0F0F0'}/>
          </Box>
        </GridItem>
        <GridItem colSpan={1}  mt={["15px",'32px']} mb={['40px','0px']}>
        <HStack gap={['20px',"10px"]}  justifyContent={["flex-start","flex-end"]}>
          <Box>
            <Text fontWeight={"600"}  fontSize={['11px',"16px"]} color={"#808080"}>
              Rate:
            </Text>
      ...
      <Box mb={"40px"} mt={"40px"} bg={"#F8F8F8"} p={"16px"} rounded={"4px"}>
        <HStack>
          ...
          <Box>
            ...
            To sell your crypto. click on the green button below to generate a wallet address to send your crypto.
            </Text>
          </Box>
        </HStack>
      </Box>
    ...
    columns={[1,3]}>
      ...
      <Box mb={"40px"} mt={"40px"} bg={"#F8F8F8"} p={"16px"} rounded={"4px"}>
        <HStack>
          ...
          <Box>
            <Text fontWeight={"500"} fontSize={"14px"} color={"#808080"} >
            To buy crypto. click on the green button below to generate a bank account to transfer funds to.
            </Text>
          </Box>
        </HStack>
      </Box>
